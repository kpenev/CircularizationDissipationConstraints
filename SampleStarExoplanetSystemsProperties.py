...
class PriorTransform:
    ...
    def __call__(self, u):
        ...
        if 'ratio of planet to stellar radius' in self.means:
            if self.standard_deviations['ratio_of_planet_to_stellar_radius_upper_uncertainty'] is not None and self.standard_deviations['ratio_of_planet_to_stellar_radius_lower_uncertainty'] is not None and secondary_radius is None:
