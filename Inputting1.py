...
if __name__ == '__main__':
    ...
    if args.i:
        ...
        if args.power_of_the_ratio_of_planetary_and_stellar_radius:
            string = 'python3 SampleStarExoplanetSystemsProperties1.py --measured_values \'' + string_measured_values + '\' --standard_deviations \'' + string_standard_deviations + '\' --system \'' + system_name + '\' --power_of_the_ratio_of_planetary_and_stellar_radius ' + args.power_of_the_ratio_of_planetary_and_stellar_radius
        else:
            string = 'python3 SampleStarExoplanetSystemsProperties1.py --measured_values \'' + string_measured_values + '\' --standard_deviations \'' + string_standard_deviations + '\' --system \'' + system_name + '\''
