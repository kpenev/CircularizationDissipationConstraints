...
for i in range(0, (len(planet_id)-1)):
   planet = planet + [TransitingExoplanet(planet_id[i], semi_major_axis[i], 0, 0, orbital_period[i], 0,0, transit_duration[i], 0,0, planet_radius[i], 0,0, star_radius[i], 0,0, impact_parameter[i],0,0)]
